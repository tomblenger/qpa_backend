...
router.post('/dashboard/getprojectforuser', UacPermission('edit_project', 'delete_projects'), ProjectController.getAllProjectsForUser);
...
router.get('/getalltask', UacPermission('edit_task', 'delete_tasks'), TaskController.getAllTasks);
...
router.post('/dashboard/gettaskforclient', UacPermission('edit_task', 'delete_tasks'), TaskController.getAllTasksForClient);
